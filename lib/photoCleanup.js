import { fetchSheetRows, fetchRowColors, fetchPurchaseInfo } from "./googleSheets";
import { classifySale } from "./purchaseClassification";
import { SHEET_RANGES, sheetNameFor } from "./sheetConfig";
...
async function getEliminationStatus(sourceKey) {
  ...
  const range = SHEET_RANGES[sourceKey];
