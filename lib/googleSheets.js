...
// NOTE: Purchase/Bid Price in the app is modeling-only and never writes to
// the sheet. Column AF (Price Paid at auction) is written exclusively by the
// purchase flow (writePurchaseInfo, via the Base Figures Sale Price entry).
